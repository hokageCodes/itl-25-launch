...
const SuccessComponent = ({ onBack }) => (
  <div className="p-8 mt-24 md:border-l md:w-2/3 flex flex-col items-center">
    <div className="flex items-center justify-center text-butter mb-4">
      <svg
    ...
    <div className="text-center text-lg font-semibold text-butter">Thank you for volunteering!</div>
    <div className="text-center mt-4">
      <button aria-label="Back" onClick={onBack} className="text-wine underline">Go back home</button>
    </div>
  </div>
);
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex justify-center items-center bg-cream px-4 pt-16 md:pt-0">
        <div className="flex flex-col md:flex-row bg-cream shadow-lg rounded-lg overflow-hidden max-w-4xl w-full">
          <div className="p-8 space-y-4 md:w-1/2 bg-deepBlue text-white">
          ...
          {success ? (
            ...
            <div className="p-8 md:border-l md:w-2/3">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-darkBrown">Name</label>
                  <input
                    id="name"
                    name="name"
                    type="text"
                ...
                <div>
                  <label htmlFor="committee" className="block text-sm font-medium text-darkBrown">Choose your Committee</label>
                  <select
                    id="committee"
                    name="committee"
                    required
                ...
                <button
                  aria-label="Submit"
                  type="submit"
                  className={`w-full py-2 px-4 bg-deepBlue text-white hover:bg-butter rounded focus:outline-none ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                  disabled={loading}
                >
