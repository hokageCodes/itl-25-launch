...
const faqs = [
  ...
  { 
    ...
    answer: "The ITL Conference has been scheduled to hold between April 4-5, 2025 in the city of Calgary, Alberta." 
  },
  { 
  ...
  { 
    ...
    answer: `
      ...
      <ul>
        <li><strong>Air Canada:</strong> <br />
          <ul>
            <li>North America: 5% off on standard fares, 10% off on flex fares & higher.</li>
            <li>International Travel: 10% off on standard fares & higher.</li>
            <li>Promotion Code: <strong>RXZE7G31</strong></li>
          </ul>
        </li>
        <li><strong>WestJet:</strong>
          <ul>
            <li>5% off Econo and 10% off EconoFlex and Premium fares for travel within Canada.</li>
            <li>2% off Econo, 5% off EconoFlex, and 10% off Premium base fares for trans-border travel.</li>
            <li>Coupon Code: <strong>4X7Y5UF</strong>, Promo Code: <strong>YBN31</strong></li>
          </ul>
        </li>
      </ul>
  ...
  { 
    question: "Are there opportunities for sponsorship or exhibition at the ITL Conference?", 
    answer: "Yes, we have different sponsorship opportunities available for the conference. For more details, please visit our sponsorship page or reach out to us at info@itlconference.ca" 
  },
  { 
    question: "How can I stay updated on the latest updates on the conference?", 
    answer: "To stay informed about the conference, please register on the conference registration page and we will make sure to keep you in the loop with additional details." 
  },
];
        ...
        <div className="space-y-6">
          {faqs.map((faq, index) => (
            <div key={index} className="bg-white shadow-lg rounded-lg p-4">
              ...
              {activeIndex === index && (
                <div className="mt-4 text-darkBrown text-lg" dangerouslySetInnerHTML={{ __html: faq.answer }} />
              )}
            </div>
          ))}
        </div>
